 ...
 */
static inline bool c_list_is_linked(const CList *what) {
 ...
 */
static inline bool c_list_is_empty(const CList *list) {
 ...
 */
static inline bool c_list_contains(const CList *list, const CList *what) {
        const CList *iter;
